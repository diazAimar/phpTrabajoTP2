    ...
    */
    function pedirFuncionesTeatro(){
        ...
        for($i = 0; $i<$cantFuncInicial; $i++) {
            ...
            $funcionesArreglo[$i] = new Funcion($nombreFuncion, $horarioFuncion, $duracionFuncion, $precioFuncion);
        }
    ...
    */
    function revisarDisponibilidadHorario($arregloFun, $horarioFun, $duracionFun, $cantArr){
        ...
        do{
            ...
            if(($minutosInicioFuncion < $minutosInicioFuncionAnt && $minutosFinFuncion < $minutosInicioFuncionAnt) || ($minutosInicioFuncion > $minutosFinalFuncionAnt && $minutosFinFuncion < $minutosInicioFuncionAnt)) {
                $horarioDisponible = true;
            }
            else {
    ...
    */
    function imprimirInformacionActual($objTeatro){
        ...
        for($i=0; $i<count($objTeatro -> getFuncionesTeatro()); $i++) {
            echo "\033[00;36mFuncion " . ($i+1) . "\033[0m: " . $objTeatro -> getFuncionesTeatro()[$i] -> getNombre() . ", $" . $objTeatro -> getFuncionesTeatro()[$i] -> getPrecio() . ". Horario de inicio: " . $objTeatro -> getFuncionesTeatro()[$i] -> getHorarioDeInicio() . ". Duracion: " . $objTeatro -> getFuncionesTeatro()[$i] -> getDuracion() . " minutos.\n"; 
        }
    }
